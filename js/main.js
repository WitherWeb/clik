...
const blueMarker = document.querySelectorAll('.graph-blue-mark');
const redMarker = document.querySelectorAll('.graph-red-mark');
const blueMarkerInfo = document.querySelectorAll('.graph-info-blue');
const redMarkerInfo = document.querySelectorAll('.graph-info-red');
blueMarker.forEach(el => {
  el.addEventListener('mouseenter', function (e) {
    let re = el.closest('.result__progress-graph').querySelector('.graph-info-blue').classList.add('graph-info-red--active');
  });
  el.addEventListener('mouseout', function (e) {
    let re = el.closest('.result__progress-graph').querySelector('.graph-info-blue').classList.remove('graph-info-red--active');
  });
});
redMarker.forEach(el => {
  el.addEventListener('mouseenter', function (e) {
    let re = el.closest('.result__progress-graph').querySelector('.graph-info-red').classList.add('graph-info-red--active');
  });
  el.addEventListener('mouseout', function (e) {
    let re = el.closest('.result__progress-graph').querySelector('.graph-info-red').classList.remove('graph-info-red--active');
  });
});
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.completed__swiper', {
  slidesPerView: '3',
  spaceBetween: 15,
  loop: true,
  navigation: {
    nextEl: '.completed__swiper-prev',
    prevEl: '.completed__swiper-next'
  },
  pagination: {
    el: '.completed__swiper-pagination',
    type: 'fraction'
  },
  breakpoints: {
